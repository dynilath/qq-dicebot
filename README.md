...
> DiceBot：``` * dynilath 掷骰: d20 + d6 + 2d4 = 20```
...
> DiceBot：``` * dynilath 掷骰: 4d6 = [3 + 5 + 6 + 1] = 15```
...
> DiceBot：``` * dynilath 掷骰: 4d6k3 = [2 + 3 + 3 + (2)] = 8```  
...
不用担心，骰子机器人是支持算式的。  
> dynilath：```.rs(((4d6+3)/2+2d20)+4*1d6)*150%```

> DiceBot：``` * dynilath 掷骰: (((4d6 + 3) / 2 + 2d20) + 4 * 1d6) * 150% = ((([1 + 3 + 2 + 2] + 3) / 2 + [8 + 6]) + 4 * [2]) * 150% = 41.250000```  

当然，如果你的算式输入格式有问题，多余的部分会被识别成骰子描述。  
> dynilath：```.rs4d6+(((4d6+3)/2+2d20)+4*1d6```

> DiceBot：``` * dynilath +(((4d6+3)/2+2d20)+4*1d6 掷骰: 4d6 = [3 + 5 + 3 + 5] = 16```  
